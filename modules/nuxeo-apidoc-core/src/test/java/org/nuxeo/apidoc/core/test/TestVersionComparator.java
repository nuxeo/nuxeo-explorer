...
public class TestVersionComparator {
    ...
    public void testList() {
        ...
        assertEquals(Arrays.asList("11.2.0", "11.2.1-SNAPSHOT", "11.2.1", "11.2.3-I20200929", "11.2.3-SNAPSHOT",
                "11.2.3", "11.2.10", "11.2.49", "11.2.53", "11.2-RC1", "11.2-RC2", "11.2-RC10", "11.2-bar", "11.2-foo",
                "11.2", "11.3", "11.10"), versions);
    }
