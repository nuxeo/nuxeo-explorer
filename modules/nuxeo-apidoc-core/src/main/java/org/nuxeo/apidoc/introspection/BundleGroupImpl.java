...
public class BundleGroupImpl extends BaseNuxeoLiveArtifact implements BundleGroup {
    ...
    public List<BundleGroup> getSubGroups() {
        return subGroups.stream().sorted(new NuxeoArtifactComparator()).collect(Collectors.toUnmodifiableList());
    }

    @Override
    public List<String> getBundleIds() {
        return bundleIds.stream().sorted().collect(Collectors.toUnmodifiableList());
    }
