...
# SUPINT-1863: don't break jsf-ui package installation on a hotfix distrib
#echo "Clean up package installation directories: $backupDir, $tmpDir"
echo "Clean up package installation directories: $tmpDir"
#rm -rf $backupDir
rm -rf $tmpDir
echo

# Set appropriate permissions on distribution directory
# SUPINT-1863: moved to Dockerfile as it takes ages
